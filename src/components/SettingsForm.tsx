      ...
      {tab === "data" && (
        ...
        >
          <Card
            ...
            description="A spreadsheet of your banks, accounts, balance history, money moves, checks, reminders, and address changes, plus every document you've uploaded — all in one zip."
          >
            <a
