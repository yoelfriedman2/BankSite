    ...
    <div className="space-y-6">
      ...
      <section className="rounded-2xl border border-slate-200 bg-white p-5">
        <div className="mb-1 flex items-center gap-2">
          ...
          <h2 className="text-sm font-semibold text-slate-800">CD interest</h2>
        </div>
        <p className="mb-4 text-sm text-slate-500">
          Projected annual interest for every CD with a rate filled in (balance
          × rate). Add a rate from the account editor to include one here.
        </p>
