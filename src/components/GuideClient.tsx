...
const TOPICS: Topic[] = [
  ...
  },
  {
    ...
    tips: [
      ...
      "A third section, \"Waiting to post,\" holds checks you mailed in through Send money that haven't posted yet — see the Send money & letters topic for how those get here and how to resolve one.",
    ],
  },
  {
    id: "balances",
  ...
  },
  {
    ...
    points: [
      ...
      "A mailed check posts on its own — or when you say so",
    ],
    tips: [
  ...
  },
  {
    ...
    points: [
      ...
      "Alerts & emails: dormancy window, minimum balance, default days until a mailed deposit posts, which Needs-attention alerts are on, which emails you get",
