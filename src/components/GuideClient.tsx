...
const TOPICS: Topic[] = [
  ...
  },
  {
    ...
    tips: [
      ...
      "With an account open, use the ‹ › arrows next to Close (or ↑/↓ on your keyboard) to step to the previous or next account without closing the view — it follows whatever sort or filter is currently applied.",
    ],
  },
  {
    id: "active",
  ...
  },
  {
    id: "send",
    icon: Mail,
    title: "Send money & letters",
    blurb: "Build the whole envelope — letter, deposit ticket, and check — in one print job.",
    points: [
      "Pick a bank; the mailing address fills itself in",
      "Pre-written letters for the usual reasons",
      "Everything stays editable before it prints",
      "Laid out for a window envelope",
      "Printing logs the activity for you",
    ],
    tips: [
      ...
      "A check can be drawn on one of your own accounts — the balance comes down and it's added to the check register — or on an outside personal account. Save that outside account once (name, bank, routing and account number) and it's there next time.",
      ...
      "If the account you're paying from has no routing number saved, you'll get a warning: on blank paper the check would print without a usable MICR line. On pre-printed stock it doesn't matter, since that line is already on the paper.",
      "Printing logs activity on the account you picked, which is what resets the dormancy clock. Untick that in step 4 if you'd rather record it yourself later.",
